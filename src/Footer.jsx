    ...
    <footer className="site-footer">
      <div className="footer-columns">
        <div className="footer-col left-col">
          <img src="./src/images/New Lomdei Logo.png" alt="Lomdei Logo" className="footer-logo" />
        ...
        <div className="footer-col center-col">
          <div className="footer-center-section">
            ...
            <div className="footer-center-logo">
              <img src="./src/images/Mayberg Logo.png" alt="Mayberg Logo" className="footer-partner-logo" />
            </div>
            <div className="footer-center-logo">
              <img src="./src/images/Deep Logo.png" alt="Deep Logo" className="footer-partner-logo" />
            </div>
          </div>
        </div>
