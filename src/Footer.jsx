        ...
        <div className="footer-col center-col">
          <div className="footer-center-section">
            ...
            <div className="footer-center-logo">
              <img src="/Lomdei-2025/public/images/Mayberg Logo.png" alt="Mayberg Logo" className="footer-partner-logo" />
            </div>
            <div className="footer-center-logo">
              <img src="/Lomdei-2025/public/images/Deep Logo.png" alt="Deep Logo" className="footer-partner-logo" />
            </div>
          </div>
        </div>
